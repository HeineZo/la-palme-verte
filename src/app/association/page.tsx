  ...
  return (
    <div className='flex flex-col gap-20 px-32 pt-12'>
      ...
      <div className='flex justify-between section'>
        <div className='flex-col'>
          <div className='mb-8'>
            <div>
              ...
              <p>
                Une question, une remarque, un avis ? Venez-nous
                en parler par message ou en personne !
              </p>
            </div>
          </div>
          <div className='flex mb-8 gap-3'>
            ...
            <div>
              ...
              <span className='align-middle'>
                <a className='underline' href={`mailto:${process.env.NEXT_PUBLIC_MAIL}`}>lapalmeverte.association@gmail.com</a>
              </span>
            </div>
          </div>
        ...
        <div>
          <iframe className='rounded-medium' src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d10752.05926845766!2d-2.7461428!3d47.6452789!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48101e9be97d2849%3A0xd866b9dbcd1c8418!2sUniversit%C3%A9%20de%20Bretagne%20Sud%20UBS!5e0!3m2!1sfr!2sfr!4v1696194379296!5m2!1sfr!2sfr" width="1000" height="600" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </div>
    </div >
  );
