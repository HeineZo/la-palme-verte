  ...
  const placeholderArticles: FullBlogPost[] = [
    {
      ...
      createdAt: new Date(),
      authors: [{ id: 1, name: 'Parzival', email: '', role: 'Admin', profilePicture: '', socialMediaId: 1, description: '' }],
    ...
    },
    {
      ...
      createdAt: new Date(),
      authors: [{ id: 0, name: 'Maurice', email: '', role: 'Admin', profilePicture: '', socialMediaId: 2, description: '' }],
