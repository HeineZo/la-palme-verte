...
export default function DiscoverPhotos() {
  return (
    <div className="flex flex-col lg:flex-row gap-20 py-28 px-16 items-center justify-around bg-highlight rounded-medium w-full">
      <div className="flex flex-col gap-6 md:w-2/5 lg:w-3/6 h-fit">
        <Reveal>
        ...
        <Reveal index={3}>
          <Button
            ...
            className="w-fit invisible lg:visible"
          >
            Voir les photos
          </Button>
        </Reveal>
